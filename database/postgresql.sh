...
echo -e '\e[38;5;198m'"++++ "
echo -e ' Pull PostgreSQL Docker image'
echo -e '\e[38;5;198m'"++++ "
echo -e '\e[38;5;198m'"++++ Pulling PostgreSQL Docker image"
echo -e '\e[38;5;198m'"++++ "
#sudo docker run postgres:latest

sudo docker pull postgres:latest
sudo docker run postgres -e POSTGRES_USER=root \
         -e POSTGRES_PASSWORD=mysecretpassword \
         -e POSTGRES_HOST_AUTH_METHOD=trust \
	 -d -p 5432:5432 postgres
#sudo docker run postgres:16-alpine -e POSTGRES_USER=root \
...
echo -e '\e[38;5;198m'"++++ "
sudo docker exec postgres psql -U root -e POSTGRES_PASSWORD=mysecretpassword '\du'
